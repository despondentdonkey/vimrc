...
" Set enter and shift-enter to add a line without exiting command mode
nmap <CR> o<Esc>
nmap <S-Enter> O<Esc>
...
" Toggles the visibility of the GUI (menu bar, toolbar, scroll bars).
function! ToggleGUI()
    if &guioptions=='i'
